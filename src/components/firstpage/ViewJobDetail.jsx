        ...
        <div className="flex justify-between flex-col gap-5 md:flex-row">
          ...
          <div className="text-xl flex flex-col gap-5">
            ...
            <div>
              ...
              <p className="text-gray-500">{experience} years in this field</p>
            </div>
          </div>
          {/* info */}
          <div className="text-xl bg-purple-100 p-6 flex flex-col gap-5 md:w-1/2">
            ...
            <h1 className="font-bold border-b-4 border-white">
              Contact Information
            </h1>
            <div className="flex gap-2 items-center">
              <FaPhoneAlt />
